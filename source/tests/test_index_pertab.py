...
class TestInitFrzModelA(unittest.TestCase):
    ...
    def test_shift(self):
        ...
        run_data = [
            ...
            self.dp.model.backbone.delta_pair_rep_before_ln,  # 17
            self.dp.model.backbone.delta_pair_rep_after_ln,  # 18
        ...
        feed_dict_ckpt_0 = self.dp.get_feed_dict(valid_batch, is_training=False)
